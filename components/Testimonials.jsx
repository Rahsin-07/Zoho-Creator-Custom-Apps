    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: 'Inter,sans-serif', fontWeight: 600, fontSize: '0.94rem', color: '#0b1220' }}>{t.name}</div>
            ...
            <div key={t.name} className={`col-md-6 col-lg-4 fade-up ${['zx-sl','zx-su','zx-sr'][i % 3]}`} style={{ transitionDelay: `${i * 0.08}s` }}>
              ...
              >
                ...
                <div style={{
                  ...
                  <div>
                    <div style={{ fontFamily: 'Inter,sans-serif', fontWeight: 600, fontSize: '0.92rem', color: '#0b1220' }}>{t.name}</div>
