    ...
    <section id="faq" style={{ background: '#fff' }} ref={ref}>
      <div className="container">
        <div className="text-center mb-5 fade-up" style={{ maxWidth: 720, margin: '0 auto 56px' }}>
          ...
          <h2 className="section-title" style={{ fontWeight: 600 }}>Common questions about <span className="grad-blue-purple">ZoFlowX</span></h2>
                ...
                return (
                  <div key={i} style={{
                    ...
                    <button onClick={() => setOpen(isOpen ? -1 : i)} style={{
                      ...
                      fontFamily: 'inter Sans,sans-serif', fontWeight: 600,
                    ...
                    <div style={{
                      ...
                      <div style={{ padding: '0 26px 24px 26px', fontSize: '0.92rem', color: '#475569', lineHeight: 1.75, fontFamily: 'Inter,sans-serif' }}>{faq.a}</div>
                    </div>
                  </div>
                )
              })}
